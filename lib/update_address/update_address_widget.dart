...
class UpdateAddressWidget extends StatefulWidget {
  ...
  static String routePath = '/updateAddress';
...
class _UpdateAddressWidgetState extends State<UpdateAddressWidget> {
  ...
  void initState() {
    ...
    _model.updateAddressFieldFocusNode ??= FocusNode();
  }
    ...
    return Scaffold(
      ...
      body: Align(
        ...
        child: Container(
          ...
          child: FutureBuilder<List<UserAddressRow>>(
            future: UserAddressTable().querySingleRow(
            ...
            builder: (context, snapshot) {
              ...
              List<UserAddressRow> columnUserAddressRowList = snapshot.data!;

              final columnUserAddressRow = columnUserAddressRowList.isNotEmpty
                  ? columnUserAddressRowList.first
                  : null;
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      width: 370.0,
                      child: TextFormField(
                        controller: _model.updateAddressFieldTextController ??=
                            TextEditingController(
                          text: columnUserAddressRow?.address,
                        ),
                        focusNode: _model.updateAddressFieldFocusNode,
                        autofocus: true,
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await UserAddressTable().update(
                            data: {
                              'address':
                                  _model.updateAddressFieldTextController.text,
                            },
