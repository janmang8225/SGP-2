                          ...
                          children: [
                            ...
                            FutureBuilder<List<CartRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<CartRow> listViewCartRowList =
                                    snapshot.data!;
                                            ...
                                            Padding(
                                              ...
                                              child: StreamBuilder<
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  List<UserCartTotalPriceRow>
                                                      rowUserCartTotalPriceRowList =
                                                      snapshot.data!;

                                                  final rowUserCartTotalPriceRow =
                                                      rowUserCartTotalPriceRowList
                                                              .isNotEmpty
                                                          ? rowUserCartTotalPriceRowList
                                                              .first
                                                      ...
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          await UserCartTotalPriceTable()
                                                              .update(
                                                            data: {
                                                              'totalPrice': functions.subtract2num(
                                                                  rowUserCartTotalPriceRow!
                                                                      .totalPrice,
                                                                  listViewCartRow
                                                                      .itemPrice!),
                                                            },
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 24.0),
                              child: StreamBuilder<List<UserCartTotalPriceRow>>(
                                stream: _model.priceSummarySupabaseStream ??=
                                    SupaFlow.client
                                        .from("userCartTotalPrice")
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<UserCartTotalPriceRow>
                                      priceSummaryUserCartTotalPriceRowList =
                                      snapshot.data!;

                                  final priceSummaryUserCartTotalPriceRow =
                                      priceSummaryUserCartTotalPriceRowList
                                              .isNotEmpty
                                          ? priceSummaryUserCartTotalPriceRowList
                                              .first
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              valueOrDefault<String>(
                                                priceSummaryUserCartTotalPriceRow
                                                    ?.totalPrice
                                                    ?.toString(),
                                                '0',
                                              ),
