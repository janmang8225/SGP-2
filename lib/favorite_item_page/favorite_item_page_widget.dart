...
import 'favorite_item_page_model.dart';
export 'favorite_item_page_model.dart';

class FavoriteItemPageWidget extends StatefulWidget {
  const FavoriteItemPageWidget({super.key});

  static String routeName = 'favoriteItemPage';
  static String routePath = '/favoriteItemPage';

  @override
  State<FavoriteItemPageWidget> createState() => _FavoriteItemPageWidgetState();
}

class _FavoriteItemPageWidgetState extends State<FavoriteItemPageWidget> {
  late FavoriteItemPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FavoriteItemPageModel());
  }
