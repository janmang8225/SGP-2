...
GoRouter createRouter(AppStateNotifier appStateNotifier, [Widget? entryPage]) =>
    GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: ViewItemsWidget.routeName,
          path: ViewItemsWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'viewItems')
              : ViewItemsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: FoodCategoryPageWidget.routeName,
          path: FoodCategoryPageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'foodCategoryPage')
              : FoodCategoryPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: FavoriteItemPageWidget.routeName,
          path: FavoriteItemPageWidget.routePath,
          builder: (context, params) => FavoriteItemPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: Temp1Widget.routeName,
          path: Temp1Widget.routePath,
          builder: (context, params) => Temp1Widget(),
        ),
        FFRoute(
          name: UpdateAddressWidget.routeName,
          path: UpdateAddressWidget.routePath,
